[ -f "$HOME/.omp/oh-my-posh" && -f "$HOME/.omp/themes/tupl.omp.json" ] && eval "$($HOME/.omp/oh-my-posh init bash --config $HOME/.omp/themes/tupl.omp.json)"
...
_exists 'terraform' && alias 'tf'='terraform'
...
# export PROTON_PASS_TOKEN='PROTON_PASS_TOKEN'
